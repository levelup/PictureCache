...
/**
 * basic class to run some code in the UI thread, based on {@link AbstractUIHandler}
 */
public final class UIHandlerThread extends Handler implements AbstractUIHandler {
